...
<template>
  <div class="home-main">
    ...
    <div class="top" @mousemove="touchmove">
      ...
      >
        <img src="@/assets/imgs/home/front-bac/hw/front-bac1.png" alt="" />
      </div>
      <!-- <div class="front-bac2" :style="{
          transform: `translateX(${frontTransform.front2.translateX}) translateY(${frontTransform.front2.translateY})`,
        }">
        <img src="@/assets/imgs/home/front-bac/front-bac2.png" alt="" />
      </div> -->
      <div
        class="front-bac3"
        :style="{
      ...
      >
        <img src="@/assets/imgs/home/front-bac/hw/front-bac3.png" alt="" />
      </div>
      <div class="front-bac4">
        <img src="@/assets/imgs/home/front-bac/hw/front-bac4.png" alt="" />
      </div>

      <!-- 前景-end -->
      <Header :headIndex="1" @createEgg="createEgg"></Header>
      <div class="wrap">
        <div class="top-icon">
          <img src="@/assets/imgs/home/hw/home-top-logo2.png" alt="" />
        </div>
        <div class="top-title">
        ...
        <div class="top-btns">
          ...
          <div class="playGame-btn" @click="openPlayGameBox">
            <img src="../../../assets/imgs/home/home-top-gamePlay-btn.png" />
          </div>
        </div>
      </div>
      ...
      <div class="content-dragon-mainLand">
        <div class="wrap">
          ...
          <div class="video-des">
            ...
            based card strategy, NTF trading, DeFi, and collectibles into the
...
.home-main {
  ...
  background-image: url("../../../assets/imgs/home/hw/home-main-bac.png");
  .top {
    height: 1315px;
    // height: 100vh; // 235px
    width: 100%;
