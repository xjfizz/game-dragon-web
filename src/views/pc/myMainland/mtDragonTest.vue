<template>
  ...
  >
    <div class="my-dragon-top">
      <div class="left">{{ dragonList.length || 0 }} Dragons</div>
      <div class="right"></div>
    </div>
        ...
        >
          ...
          >
            <div class="item-wrap">
              ...
              <div class="top-breed"> Breed count: {{ item.breedCount || 0 }}</div>
              <div class="top-ce">
                <div class="top-ce-img">
                  <img :src="dragonClazzImgHandle(item.clazz)" alt="" />
                </div>
    ...
    <div class="create-selete-img" v-if="isOpening">
      <div class="dragon" v-if="selectLocalDragon">
        <indexCreateUpload
          ref="dragonCreate"
